...
-- Get the FOV radius based on X, Y, Z values from the FovSettings
local function getFovRadius()
    local fovSettings = shared.Forbidden.TriggerBot.Settings.FovSettings
    return (fovSettings.X + fovSettings.Y + fovSettings.Z) * 3
end
